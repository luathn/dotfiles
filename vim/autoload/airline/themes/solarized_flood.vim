...
"   '#':    picked manually
let s:base03  = {'hex': '#002B36', 'term': 237}  "   0,  43,  54
...
let s:yellow  = {'hex': '#B58900', 'term': 208}  " 181, 137,   0
...
let s:cyan    = {'hex': '#2AA198', 'term':   4}  "  42, 161, 152 *
let s:green   = {'hex': '#859900', 'term': 246}  " 133, 153,   0 #
