...
config.keys = {
  ...
  { key = 'V',     mods = 'LEADER',      action = wezterm.action.SplitPane { direction = 'Right', size = { Percent = 50 }, top_level = true } },
  { key = 's',     mods = 'LEADER',      action = act.SplitVertical { domain = 'CurrentPaneDomain' } },
  { key = 'S',     mods = 'LEADER',      action = wezterm.action.SplitPane { direction = 'Down', size = { Percent = 40 }, top_level = true } },
